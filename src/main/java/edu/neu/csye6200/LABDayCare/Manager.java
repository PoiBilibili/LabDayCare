...
public class Manager {
	...
	public void addStudents(List<Student> s) {
		for(Student st:s) {
			int c = st.getAge();			
			if(6<=c && c<=12) classrooms.get(0).addStudent(st);
			else if(13 <= c && c<=24) classrooms.get(1).addStudent(st);
			else if(25 <= c && c<=35) classrooms.get(2).addStudent(st);
			else if(36 <= c && c<=47) classrooms.get(3).addStudent(st);
			else if(48 <= c && c<=59) classrooms.get(4).addStudent(st);
			else if(c>=60) classrooms.get(5).addStudent(st);
		}
	}
